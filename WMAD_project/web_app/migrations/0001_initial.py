    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_type', models.CharField(choices=[('delivery', 'Delivery'), ('pickup', 'Pickup'), ('dinein', 'Dine-In')], default='pickup', max_length=20)),
        ...
        migrations.AddField(
            model_name='order',
            name='customer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web_app.customer'),
        ),
    ]
